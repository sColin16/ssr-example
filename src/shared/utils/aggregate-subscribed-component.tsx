...
export type BuildAggregateSubscribedComponentOptions<K extends keyof SiteProps, T> = {
  keys: Array<K>
 ...
 */
export function buildAggregateSubscribedComponent<K extends keyof SiteProps, T> ({
  keys,
  aggregator,
  Component
